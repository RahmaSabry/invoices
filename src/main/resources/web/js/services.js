angular.module('resourceApp', ['ngResource','ngCookies'])
...
.factory('LoginService',function ($resource,$http,Base64,$rootScope,$cookies) {
    this.resource=$resource('http://localhost:5000/login/',null, {'update': { method:'PUT' }},{    stripTrailingSlashes: false})
